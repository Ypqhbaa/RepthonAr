...
try:
    LOGS.info("يتم تفعيل وضع حماية الحساب من الاختراق")
    zedub.loop.create_task(saves())
    LOGS.info("تم تفعيل وضع حماية الحساب من الاختراق")
...
async def startup_process():
    ...
    print("============================================================")
    print("تم انتهاء عملية التنصيب بنجاح على كويب | ســورس ريبـــثون")
    print(
