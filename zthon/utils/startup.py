...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await zedub.send_message("@BotFather", "ريبـــثون")
            ...
            await zedub.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await zedub.send_file("@BotFather", "zthon/zilzal/IMG_20220821_170541_585.jpg")
            await asyncio.sleep(3)
            await zedub.send_message("@BotFather", "/setabouttext")
            await asyncio.sleep(1)
            await zedub.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await zedub.send_message("@BotFather", f"- بـوت ريبـــثون المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            await asyncio.sleep(3)
            await zedub.send_message("@BotFather", "/setdescription")
            await asyncio.sleep(1)
            await zedub.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await zedub.send_message("@BotFather", f"•⎆┊انـا البــوت المسـاعـد الخــاص بـ {ba_roger} \n•⎆┊بـواسطـتـي يمكـنك التواصــل مـع مـالكـي 🧸♥️\n•⎆┊قنـاة السـورس 🌐 @Repthon 🌐")
        except Exception as e:
            print(e)
